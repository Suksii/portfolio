  ...
  return (
    <div className="py-[10vh]">
      <div className="text-center pb-10">
        <p className="text-xl leading-7 font-dancing tracking-widest">
          Hello, I'm
        </p>
      ...
      <div className="flex justify-center gap-[6vw] items-center md:flex-row flex-col relative">
        ...
        <div className="w-[300px] h-[300px] md:w-[400px] md:h-[400px] relative rounded-full">
          <img
            src={Suco}
            alt={"Suco"}
            className="absolute w-full fancy_border_radius object-cover h-full z-30"
          />
          ...
          <FaLinkedin
            ...
            onClick={() =>
              handleOpen(
                "https://me.linkedin.com/in/%C5%A1u%C4%87o-ramovi%C4%87-58a728256",
              )
            }
          />
        </div>
      ...
      <div className="flex justify-center gap-10">
        <button
          className={`button1 flex items-center gap-1 border-t-2 ${isDarkMode ? "bg-white hover:border-white hover:bg-black hover:text-white" : "hover:border-black hover:bg-white hover:text-black bg-black text-white"} min-w-[150px] px-4 py-2 rounded-full mt-10 duration-500 uppercase font-semibold`}
          onClick={() => scrollToSection("Contact")}
        >
          Contact Me <FaHandPeace size={20} className="svg1 inline-block" />
        </button>
        <button
          className={`button2 flex items-center gap-1 ${isDarkMode ? "border-white hover:text-black hover:bg-white text-white" : "border-black hover:text-white hover:bg-black "} border-b-2 px-4 py-2 rounded-full mt-10 ml-4 duration-500 uppercase font-semibold`}
          onClick={downloadPDF}
        >
